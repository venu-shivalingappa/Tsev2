        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="space-y-5 text-[#A0A8AF]">
              <p className="text-[#626f7c] text-[#626f7c] text-[#636f7c] text-[#64707c] text-[#68727d] text-[#6d7680] text-[#737a83] text-[#797f86] text-[#7e8289] text-[#82868b] text-[#878a8e] text-[#8b8d90] text-[#8e9092] text-[#919294] text-[#949496] text-[#969697] text-[#989898] text-[#999999] text-[#99999a] text-[#9a9a9a] text-[#9a9a9b] text-[#9c9c9c] text-[#9e9e9e] text-[#a0a0a0] text-[#a3a3a3] text-[#a7a7a7] text-[#a9a9a9] text-[#acacac] text-[#aeaeae] text-[#b0b0b0] text-[#b4b4b4] text-[#b8b8b8] text-[#bcbcbc] text-[#c0c0c0] text-[#c4c4c4] text-[#c8c8c8] text-[#cccccc] text-[#cfcfcf] text-[#d2d2d2] text-[#d5d5d5] text-[#d6d6d6] text-[#d8d8d8] text-[#d8d8d8] text-[#d9d9d9] text-[#d9d9d9] text-[#dadada] text-[#dcdcdc] text-[#dddddd] text-[#dfdfdf] text-[#e1e1e1] text-[#e2e2e2] text-[#e2e2e2] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e3e3e3] text-[#e4e4e4] text-[#e7e7e7] text-[#eaeaea] text-[#eeeeee] text-[#f2f2f2] text-[#f5f5f5] text-[#f8f8f8] text-[#fbfbfb] text-[#fdfdfd] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff]">
                We are driven by the opportunity to solve complex technology challenges that enable business growth.
              </p>
              <p className="text-[#93a5b7] text-[#93a5b7] text-[#94a6b7] text-[#9eaab7] text-[#a6aeb7] text-[#afb3b8] text-[#b9b9ba] text-[#bdbdbd] text-[#c6c6c6] text-[#cacaca] text-[#cecece] text-[#d1d1d1] text-[#d4d4d4] text-[#d7d7d7] text-[#dadada] text-[#dedede] text-[#e0e0e0] text-[#e3e3e3] text-[#e6e6e6] text-[#e8e8e8] text-[#eaeaea] text-[#ececec] text-[#efefef] text-[#f1f1f1] text-[#f3f3f3] text-[#f5f5f5] text-[#f7f7f7] text-[#f9f9f9] text-[#fcfcfc] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff] text-[#ffffff]">
